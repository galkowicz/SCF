...
app.controller('SoundCloud', ['$http', '$scope','$localStorage', function ($http, $scope, $localStorage) {
    SC.initialize({
...
//app.controller('saveHistory', function($scope, $localStorage){
//
//    $scope.addToHistory = function(){
//        $localStorage.prevPageData = $scope.search;
//    };
//
//});
